 ...
 * test_l3_action.php
 * 
 * Тестирует L3 Action add-car-to-garage с реальными Telegram данными
 */

require_once __DIR__ . '/services/BotService.php';
require_once __DIR__ . '/utils/Logger.php';

echo "🧪 Тестируем L3 Action add-car-to-garage...\n";
...
echo "\n🔗 Тестируем эндпоинт: /api/actions/add-car-to-garage (POST)\n";

// Вызываем API
$result = $botService->callBackendApi('/api/actions/add-car-to-garage', $apiData, $userData);
