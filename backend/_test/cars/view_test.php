...
<html>
<head>
    <title>Тест: Просмотр авто /api/cars/view</title>
    <style>
...
<body>
<div class="container">
    <h1>🧪 Тест: Просмотр авто <span style="font-size:0.7em; color:#888">/api/cars/view</span></h1>
    <div class="section">
        ...
        <form id="requestForm">
            ...
            <div class="form-group">
                <label>car_id:</label>
                <input type="number" name="car_id" placeholder="ID авто (опционально)">
            </div>
            <div class="form-group">
                <label>reg_number:</label>
                <input type="text" name="reg_number" placeholder="Рег. номер (опционально)">
            </div>
...
document.getElementById('requestForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('/app/backend/api/cars/view.php', {
            method: 'POST',
