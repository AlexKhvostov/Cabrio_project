...
class SessionMiddleware {
    ...
    public function handle($request) {
        ...
        // Проверка членства в чате на каждом запросе избыточна. По новой архитектуре проверка производится только при создании сессии (авторизации). Оставлено закомментированным для проверки работы в ближайшее время.
    ...
    private function checkChatMembership($telegramId) {
        ...
        $chatId = $this->config['telegram']['club_chat_id'];
