...
> **Пояснение:** Пользователь считается завершившим регистрацию, если его статус не "guest" и не "external". Пользователь с этими статусами — не завершил регистрацию и не имеет доступа к основному функционалу.
