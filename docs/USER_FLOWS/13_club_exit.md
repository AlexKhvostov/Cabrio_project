...
## 3. Участники и роли
- Пользователь (member, user, guest)
...
4. Если пользователь снова вступает в чат, при следующей проверке роль обновляется:
   - Если у пользователя есть авто/главный гость — роль user.
   - Если нет — роль guest.
...
- Если пользователь возвращается в чат — роль становится guest или user, доступ восстанавливается.

## 7. Роли пользователя и переходы

> В этом разделе описаны только роли пользователя (см. docs/USER_ROLES.md)
- member/user/guest → external (при выходе из чата)
- external → guest/user (при возвращении в чат)
...
- Пользователь возвращается в чат — роль становится guest или user, доступ восстанавливается
