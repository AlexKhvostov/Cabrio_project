# 📋 Схема базы данных CabrioRide

> Полное описание всех таблиц, полей, связей и ограничений
...
> Каталоги связаны с основными таблицами через внешние ключи (см. RELATIONS.md). Используются для выпадающих списков, фильтрации, валидации и отображения данных во всех модулях системы.

---

**📚 См. также:** [Обзор БД](OVERVIEW.md), [Связи таблиц](RELATIONS.md), [Статусы и роли](STATUSES_AND_ROLES.md) 