...
### **Просмотр событий:**
- **гость** — нет доступа к списку
- **пользователь** — список, карточка и ответ «еду». Имена людей в регистрации — с роли участник
- **участник** — всё выше + создание своих встреч
- **модератор** — всё + модерация
- **администратор** — полный доступ

### **Создание событий:**
- **участник** — создание своих событий
- **модератор** — создание любых событий
- **администратор** — создание любых событий

### **Редактирование событий:**
- **Создатель события** — редактирование своего события
- **модератор** — редактирование любых событий
- **администратор** — редактирование любых событий
